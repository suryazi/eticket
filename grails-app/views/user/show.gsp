            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.level.label" default="Level" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "level")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.tickets.label" default="Tickets" /></td>
